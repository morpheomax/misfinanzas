            ...
            <tbody>
                @forelse ($acumuladoAnualCategoria as $ingreso)
                    <tr class="hover:bg-gray-50 border-gray-50">
                        <td class="px-4 py-2 border-b" aria-label="Año de ingreso">{{ $ingreso->year }}</td>
                        <td class="px-4 py-2 border-b" aria-label="Categoría de ingreso">{{ $ingreso->categoria }}</td>
                        <td class="px-4 py-2 text-xl text-right font-bold" aria-label="Monto total">
