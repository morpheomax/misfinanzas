<div class="my-6 ">
    <h3 class="text-2xl font-semibold text-gray-800 text-center">Filtrar Egresos</h3>
    <form action="{{ route('egresos.index') }}" method="GET" class="flex flex-wrap gap-4  items-center ">
        <div>
